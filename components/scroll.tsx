...
export const Scroll = () => {
  return (
    <div className="flex flex-col h-screen w-screen self-center">
      <ScrollCore />
    </div>
  );
};
export const ScrollCore = () => {
  ...
  return (
    <div className="transform scale-[0.8] p-10 flex items-center justify-center relative ">
      <div
  ...
  return (
    ...
    >
      <h1 className="text-4xl font-semibold text-white">
        ...
        <span className="text-5xl lg:text-6xl text-white  font-bold mt-1 leading-none">
          Scroll Animations
        </span>
      </h1>
    </motion.div>
